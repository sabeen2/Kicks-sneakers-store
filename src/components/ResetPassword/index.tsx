...
import { useGenerateOtp, useResetPassword } from "../../api/user/queries";
...
const ResetPassword: React.FC = () => {
  ...
  const { mutate: generateOtp, isLoading: isSendingToken } = useGenerateOtp();
  ...
  const { mutate: resetUserPassword, isLoading: isResetingPassword } =
    useResetPassword();
